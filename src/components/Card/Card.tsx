...
const Card: FC<CardProps> = ({
  ...
  const _renderCardTitle = () => {
    return (
      <h2
        className={`${classNameTitleCard} ${styles.cardTitle} ${styles[colorTitleCard]} ${styles[fontSizeTitleCard]} ${styles[alignTitleCard]} ${
          darkMode ? styles.dark : ''
        }`}
        style={{ ...styleTitleCard, color: colorTitleCard }}
      >
        {titleCard}
      </h2>
    );
  ...
  const _renderIcon = () => {
    return (
      <div className={`${styles.cardIcon} ${styles[alignIcon]}`}>
        <Icon
          iconImg={iconImg}
