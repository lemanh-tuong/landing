...
const Section2: FC<Section2Props & Section2PropsBuilder> = ({
  ...
  const _renderCardDefault = (cardProperty: CardProps, index: number) => {
    return <Card {...cardProperty} isBuilder={isBuilder} onEditable={_handleonShowPopupEditCard(index)} />;
  };
                ...
                <div className={styles.cardEdit}>
                  ...
                  <div className={styles.btnGroup}>
                    ...
                    <Button
                      ...
                      shape="circle"
                      size="large"
                      onClick={_handleDeleteCard(index)}
                    />
                  </div>
                </div>
              </Col>
  ...
  const _renderBodyDefault = () => {
    return <Row>{_renderRowContent()}</Row>;
  };
