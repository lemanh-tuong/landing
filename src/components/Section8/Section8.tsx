      ...
      <Row>
        <Col cols={[12, 12, 7]}>
          <Row>
            ...
            <Col cols={[12, 6, 6]}>
              {card2s && card2s.slice(1, card2s.length).map((cardProperty, index) => <Card hasIcon={true} {...cardProperty} isBuilder={isBuilder} onEditable={handleShowPopupEditCard(index)} />)}
            </Col>
          </Row>
        </Col>
