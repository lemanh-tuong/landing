...
const getDataComponent = createAsyncAction(['@getDataComponentRequest', '@getDataComponentSuccess', '@getDataComponentFailure'])<null, ActionGetComponentSuccess[], string>();
